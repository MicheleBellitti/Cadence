...
import type { Item, TeamMember, Sprint, GanttOverride } from "@/types";
import {
...
/**
 * Pure document converters live in `firestore-converters` so the Cloud
 * Functions connector can reuse them without importing the browser SDK.
